...
AdminSchema.post('save', (doc) => __awaiter(void 0, void 0, void 0, function* () {
    yield model_1.AuthModel.create({ email: doc.email, role: 'Admin' });
}));
AdminSchema.post('findOneAndDelete', (doc) => __awaiter(void 0, void 0, void 0, function* () {
